...
if($.fn.owlCarousel){var welcomeSlider=$('.welcome-slides');welcomeSlider.owlCarousel({items:1,loop:true,autoplay:true,smartSpeed:1500,autoplayTimeout:7000})
...
if($.fn.owlCarousel){var testiSlide=$('.testimonial-slide');testiSlide.owlCarousel({items:4,margin:50,loop:true,autoplay:true,smartSpeed:1500,dots:true,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}});}
...
if($.fn.jarallax){$('.jarallax').jarallax({speed:100});}
if($.fn.scrollUp){hami_window.scrollUp({scrollSpeed:1500,scrollText:'<i class="arrow_carrot-up"</i>'});}
